...
class BiosControllerTest < ActionController::TestCase
  ...
  test "should create bio" do
    assert_difference('Bio.count') do
      post :create, bio: { city: @bio.city, name: @bio.name, user_id: @bio.user_id, website: @bio.website }
    end
  ...
  test "should update bio" do
    patch :update, id: @bio, bio: { city: @bio.city, name: @bio.name, user_id: @bio.user_id, website: @bio.website }
    assert_redirected_to bio_path(assigns(:bio))
  end
